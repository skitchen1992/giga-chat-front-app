import { ArrowUpIcon, FileText, Plus, Square, X } from "lucide-react";
...
function ChatInput() {
  ...
  const pendingRequestRef = useRef<ReturnType<typeof getCompletions> | null>(
    null
  );
  ...
  const handleSend = async () => {
    ...
    if (resolvedChatId) {
      ...
      const request = getCompletions({ messages });
      ...
      try {
        ...
        // запрос прерван или завершился с ошибкой — ответ ассистента не сохраняем
        return;
      } finally {
